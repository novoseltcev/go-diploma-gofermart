...
func (r *repository) UpdateBalance(ctx context.Context, userID models.UserID, value models.Money) error {
	_, err := r.tx.ExecContext(ctx, "UPDATE users SET balance = $1::MONEY WHERE id = $2", value, userID)
	return err
}


func (r *repository) GetUserWithdrawals(ctx context.Context, userID models.UserID) (result []models.Withdraw, err error) {
...
func (r *repository) GetTotalWithrawn(ctx context.Context, userID models.UserID) (result models.Money, err error) {
...
func (r *repository) CreateWithdrawal(ctx context.Context, userID models.UserID, sum models.Money, order string) error {
